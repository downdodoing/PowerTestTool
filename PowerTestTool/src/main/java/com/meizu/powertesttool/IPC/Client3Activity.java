...
public class Client3Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent1 = new Intent(this, Client3Service.class);
        bindService(intent1, cnn1, BIND_AUTO_CREATE);

        Intent intent = new Intent(this, Client2Service.class);
    ...
    public void bntClick(View view) {
        switch (view.getId()) {
            case R.id.getData:
                ...
                break;
            case R.id.goto_next:
                startActivity(new Intent(this, Client4Activity.class));
                break;
        }
    }
